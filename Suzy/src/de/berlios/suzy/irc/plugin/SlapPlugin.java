...
/**
 * Slap plugin that.picks a random class from the class library,
 * adds a short description and slaps the target with it.
 *
 * @author fx21
 */
...
public class SlapPlugin implements Plugin
{
	...
	try {
	    ...
	    Class<?> theClass = Class.forName(randomClass,
					      false,
	...
	return classes[(int)(classes.length*Math.random())].getName();
